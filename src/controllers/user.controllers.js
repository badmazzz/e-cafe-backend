...
const registerUser = asyncHandler(async (req, res) => {
  ...
  const { email, username, password, street, zipcode, city, phone } = req.body;
  console.log(req.body);
  if (
    [email, username, password, street, zipcode, city, phone].some(
      (field) => field?.trim() === ""
    )
  )
...
const getOrderHistory = asyncHandler(async (req, res) => {
  const userOrderHistory = await Order.aggregate([
    {
